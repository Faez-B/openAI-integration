    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 order-1 order-md-3">
            ...
            <div class="p-3 bg-light border rounded-3 example">
                Translate this into 1. French, 2. Spanish and 3. Japanese:<br/>
<br/>
                What rooms do you have available?<br/>
<br/>
                1. Quels sont les chambres que vous avez disponibles?<br/>
                2. ¿Qué habitaciones tienes disponibles?<br/>
                3. どの部屋が利用可能ですか？<br/>
            </div>
        </div>
    </div>
